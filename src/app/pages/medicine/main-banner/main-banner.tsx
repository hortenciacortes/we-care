...
import align from "@assets/images/main-banner/slide2.jpeg";
    ...
    <section className={`${style.container} grid-pattern`}>
      <div className={style.bannerContent}>
        <div className={style.containInfo}>
          <h1>Medicina</h1>
          <p>
            Na WeCare Medicina, unimos tecnologia de ponta e cuidado humano para transformar sua saúde. <br />
            Agende sua consulta e descubra como podemos cuidar do seu bem-estar com excelência e inovação.
          </p>
